...
const STRINGS = {
  en: {
    ...
    "install.flags.dashboards": "observability dashboard (optional, after installing): set DASHBOARDS_ENABLED=true and COMPOSE_PROFILES=dashboards in the .env, then docker compose up -d — opens at :5601 (DASHBOARDS_PORT remaps)",
  ...
  pt: {
    ...
    "install.flags.dashboards": "dashboard de observabilidade (opcional, depois de instalar): defina DASHBOARDS_ENABLED=true e COMPOSE_PROFILES=dashboards no .env e rode docker compose up -d — abre em :5601 (DASHBOARDS_PORT remapeia)",
